...
image: https://assets.shubhk.me/images/blog/theme-switcher-component.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://shubhk.me/r/theme-switcher.json"
/>
...
```bash
npx shadcn@latest add @shubhkdesign/theme-switcher
```
