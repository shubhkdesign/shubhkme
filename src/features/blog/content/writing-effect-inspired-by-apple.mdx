...
image: https://assets.shubhk.me/images/blog/writing-effect-inspired-by-apple.webp
category: components
...
<ComponentPreview
  ...
  openInV0Url="https://shubhk.me/r/apple-hello-effect.json"
  canReplay
/>
...
```bash
npx shadcn@latest add @shubhkdesign/apple-hello-effect
```
